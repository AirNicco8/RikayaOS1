...
/*
	Funzione che inizializza la lista pcbfree_h dei pcb liberi, riempiendo
	questa col contenuto dell'array pcbFree_table.
*/
...
/*
	Controlla che pcbfree_h non sia vuota (nel caso restituisce NULL)
	altrimenti rimuove un elemento e lo restituisce con tutti i campi
	azzerati.
*/
...
/*
	Controlla se la lista è vuota, nel caso restituisce TRUE,
	FALSE altrimenti
*/
...
/*
	Aggiunge p alla lista dei processi attivi, mantenendo questa
...
/*
	Restituisce l'elemento di testa della lista dei processi
	non rimuovendolo (NULL se la lista è vuota)
*/
...
/*
	Rimuove il primo elemento dalla coda di processi e lo restituisce
	(NULL se lista vuota)
*/
...
/*
	Rimuove p dalla lista dei processi se vi appartiene restituendolo,
	altrimenti (lista vuota e\o p non appartiene) restituisce NULL
*/
...
/*
	Inserisce p come figlio di prnt e nel farlo aggiorna la lista
	p_sib
*/
...
/*
	Se p ha un padre, viene rimosso dalla lista dei figli  e  restituito
	se no (p non ha padre) viene restituito NULL.
*/
